# Adressliste Brandenburg – Datenstand vom 27.08.2026
...
- SHA-256:
  `f00f57c9bb1eb805d887bf0757ee1908ee664f48b888732feb65a54ac4c4a713`
...
- Bereitsteller: **GeoBasis-DE / LGB**
- Herkunft laut Collection-Metadaten:
...
anhand des amtlichen Landesschlüssels `12` nach Brandenburg gefiltert.
`vollstaendige_adresse` wurde aus den Quellfeldern zusammengesetzt. Wenn
`ortsnamePost` leer war, wurde für das Ausgabefeld `ortsname_post`
`gemeindename` eingesetzt.
...
- 867.290 Datenzeilen mit jeweils 14 Spalten
